...
extension User {
    static let users = [
        ...
        User(name: "Курт Кобейн", userImage: "curt", dateOfBirth: "20 февраля 1967", profession: "музыкант", popularProject: "Nirvana - Nevermind"),
        ...
        User(name: "Чарльз Буковски", userImage: "bukowsky", dateOfBirth: "16 августа 1920", profession: "писатель, литератор", popularProject: "Женщины, Фактотум, Макулатура"),
        User(name: "Ева Грин", userImage: "eva", dateOfBirth: "6 июля 1980", profession: "актрисса", popularProject: "Sin City 2"),
        User(name: "Марго Роби", userImage: "margo", dateOfBirth: "2 июля 1990 ", profession: "актрисса", popularProject: "Отряд самоубийц: Миссия навылет"),
        User(name: "Моника Беллучи", userImage: "monica", dateOfBirth: "30 сентября 1964", profession: "актрисса", popularProject: "Малена"),
        User(name: "Хоакин Фениск", userImage: "hoakin", dateOfBirth: "28 октября 1974", profession: "актер", popularProject: "Джокер")
